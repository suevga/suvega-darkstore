...
export function AddCategoryForm({ onClose, onSuccess }: AddCategoryFormProps) {
  ...
  async function onSubmit(values: CategoryFormData) {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'server error creating category';
      toast({
